...
const DrinkSafetyMonitor = () => {
  ...
  const sendEmergencyNotification = async () => {
    if (!emergencyNotificationSent) {
      ...
      const webhookURL = '/.netlify/functions/emergency';
  ...
  useEffect(() => {
    if (isMonitoring) {
      intervalRef.current = setInterval(() => {
        ...
        // Check if 5 alerts reached
        if (alertCount >= 5 && !emergencyNotificationSent) {
      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex justify-between items-center mt-4 pt-4 border-t">
              ...
              <div className="flex items-center gap-4">
                <div className="text-sm">
                  ...
                  <span className={`font-bold ml-2 ${alertCount >= 5 ? 'text-red-600' : 'text-gray-800'}`}>
                    {alertCount} / 5
                  </span>
                </div>
        ...
        <div className="mt-6 bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="space-y-2 text-sm text-gray-600">
            ...
            <p><strong>Emergency Protocol:</strong> After 5 alerts, automatically contacts your designated emergency contact with location and health data</p>
